...
console.log("Intentional Index error: I want to Print Honda but mistakenly print Suzuki")
let car_companies = ["Honda", "Suzuki", "Toyota"]
console.log(car_companies[1])
console.log("Correction:")
console.log(car_companies[0])
