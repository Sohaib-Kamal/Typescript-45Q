...
for (let x=0; x < ordinalarray_length; x++) {
    if (ordinal_number[x] == 1) {console.log(ordinal_number[x] + 'st')}
    else if (ordinal_number[x] === 2) {console.log(ordinal_number[x] + 'nd')}
    else if (ordinal_number[x] === 3) {console.log(ordinal_number[x] + 'rd')}
    else  {console.log(ordinal_number[x] + 'th')}
}