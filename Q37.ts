...
function make_shirt_new (size:string = "large", text:string = "I love Typescript") {console.log('This shirt is', size, 'in size and the message to be printed on the T-Shirt is "', text + '"')}
