...
let myvehicles = ["Ford 150", "Haval H6", "Hustler"]

console.log(`${myvehicles[0]} is a great truck.`)
console.log(`${myvehicles[1]} is an epitome of luxury and comfort.`)
console.log(`${myvehicles[2]} is a very fuel efficient car.`)
