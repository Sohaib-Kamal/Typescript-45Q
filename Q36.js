...
function make_shirt(size, text) { console.log('This shirt is', size, 'in size and the message to be printed on the T-Shirt is "', text + '"'); }
make_shirt('large', "Absolutely not.");
make_shirt('small', "Work hard or not");
