...
console.log("Adding 7 with 1, we get", 7+1)
console.log("Subtracting 9 from 17, we get", 17-9)
console.log("Multiplying 16 with 0.5, we get", 16*0.5)
console.log("Dividing 56 with 7, we get", 56/7)