...
let animals = ['Whales', 'Dolphins', 'Seals']
for (let animal in animals){console.log(animals[animal])}
for (let animal in animals){console.log(animals[animal], 'are very intelligent')}
